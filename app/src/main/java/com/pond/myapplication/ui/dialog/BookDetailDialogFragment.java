...
public class BookDetailDialogFragment extends DialogFragment {
    ...
    public interface OnDialogListener {
        void onBookDetailDialogOkClick();
    }

    public static BookDetailDialogFragment newInstance(BookModel bookModel) {
        BookDetailDialogFragment fragment = new BookDetailDialogFragment();
    ...
    private void setupView() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                OnDialogListener listener = BookDetailDialogFragment.this.getOnDialogListener();
                if (listener != null) {
                    listener.onBookDetailDialogOkClick();
                }
                BookDetailDialogFragment.this.dismiss();
            }
        });
    }
    ...
    public static class Builder {
        ...
        public BookDetailDialogFragment build() {
            return BookDetailDialogFragment.newInstance(bookModel);
        }
    }
}
